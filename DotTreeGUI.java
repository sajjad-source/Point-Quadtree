...
public class DotTreeGUI extends DrawingGUI {
	...
	private void test2()
	{
		found = null;
		tree = new PointQuadtree<Dot>(new Dot(300,400), 0,0,800,600); // start with A
		tree.insert(new Dot(150,150)); // B
		tree.insert(new Dot(150,150)); // C
		tree.insert(new Dot(150,150)); // D --> insert another point on top of it
		tree.insert(new Dot(1000,150)); // E - out of bounds
		tree.insert(new Dot(550,200)); // F
		tree.insert(new Dot(700,150)); // G
		tree.insert(new Dot(775,100)); // H
		tree.insert(new Dot(600,180)); // I
	...
	public static void main(String[] args) {
		DotTreeGUI dotTreeGUI = new DotTreeGUI();
		dotTreeGUI.test0();
		dotTreeGUI.test1();
